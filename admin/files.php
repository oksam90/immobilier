...
<div class="container-fluid">
	<div class="col-lg-12">
		...
		<div class="row">
			<button class="btn btn-primary btn-sm" id="new_folder"><i class="fa fa-plus"></i> Nouveau dossier</button>
			<button class="btn btn-primary btn-sm ml-4" id="new_file"><i class="fa fa-upload"></i> Téléverser un fichier</button>
		</div>
		<hr>
		<div class="row">
			<div class="col-lg-12">
		...
		<div class="row">
			<div class="col-md-12"><h4><b>Dossiers</b></h4></div>
		</div>
		<hr>
		<div class="row">
			<?php 
...
<div id="menu-folder-clone" style="display: none;">
	...
	<a href="javascript:void(0)" class="custom-menu-list file-option delete">Effacer</a>
</div>
<div id="menu-file-clone" style="display: none;">
	...
	<a href="javascript:void(0)" class="custom-menu-list file-option delete"><span><i class="fa fa-trash"></i> </span>Effacer</a>
</div>
