						...
						<table class="table table-bordered">
							...
							<tbody>
								...
								<tr>
									...
									<?php if($row['status'] == 1): ?>
										<td class="text-center"><span class="badge badge-warning">Enregistré(e)</span></td>
									<?php else: ?>
										<td class="text-center"><span class="badge badge-success">Vérifier</span></td>
									<?php endif; ?>
									<td class="text-center">
											<button class="btn btn-sm btn-primary check_out" type="button" data-id="<?php echo $row['id'] ?>">Détails</button>
									</td>
								</tr>
							<?php endwhile; ?>
							</tbody>
